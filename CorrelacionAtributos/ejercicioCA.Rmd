...
```
## Introducción
Pokémon es un juego desarrollado por The Pokémon Company, consorcio japonós compuesto por Nintendo, Game Freak y Creatures, en el que los jugadores tienen dos objetivos principales: coleccionar Pokémon y conseguir medallas de gimnasio como misiones para terminar la historia principal del juego.
